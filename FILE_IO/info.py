...
if x=="input":
    ...
    with open ("info.csv") as file:
        ...
        #we can use it instead, but i don't have to at the moment. here's the input as example reader=csv.reader
        for line in file:
            prename,name,town,city,hood=line.rstrip().split(",")
            information={"prename":prename,"name":name,"town":town,"city":city,"hood":hood}
            informations.append(information)
            print(f"_{name} {prename}_ is from _{town}_, he lives in _{hood}_,_{city}_.")
